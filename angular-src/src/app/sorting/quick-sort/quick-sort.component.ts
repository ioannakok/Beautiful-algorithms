...
export class QuickSortComponent {
  ...
  ngAfterViewInit() {
        ...
        this.java15 = document.getElementById('java15');
        this.code.push(this.java15);
        ...
        this.java21 = document.getElementById('java21');
        this.code.push(this.java21);
        ...
        this.python14 = document.getElementById('python14');
        this.code.push(this.python14);
  ...
  animate() {
    ...
    */
    partition(array, start, end) {
        ...
        // Animate Java, Python, C++
        this.animateCode(this.java15, this.time, this.delay);
    ...
    quickSort(array, start, end) {
        ...
        if(start < end) {
            ...
            this.animateCode(this.java21, this.time, this.delay);
            this.animateCode(this.python14, this.time, this.delay);
