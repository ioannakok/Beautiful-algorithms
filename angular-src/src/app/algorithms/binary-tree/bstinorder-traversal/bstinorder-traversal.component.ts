...
@Component({
  selector: 'app-bstinorder-traversal',
  templateUrl: './bstinorder-traversal.component.html',
  styleUrls: ['./bstinorder-traversal.component.css'],
  providers: [AlgorithmsService]
})
export class BSTInorderTraversalComponent implements OnInit, OnInteract {
  ...
  constructor(private algorithmsService: AlgorithmsService) { 
    ...
    this.algorithm = this.algorithmsService.getAlgorithm(17);
  }
    ...
    /* Animate function. It updates all the animations */  
  	animate() {
        ...
        // If animation starts now, run inorder traversal once
