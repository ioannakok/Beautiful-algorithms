...
export class LinkedListInsertAtIndexComponent implements OnInit, OnInteract {
...
ngOnInit() {
    ...
    this.algorithm = this.algorithmsService.getAlgorithm(13);
  }
...
/* Animate function. It updates all the animations */  
  animate() {
        ...
        if(this.animation && !this.initAnim) {
            ...
            // Animate code
            this.animateCode(this.java6, this.time * 4, this.delay);
            this.animateCode(this.python6, this.time * 4, this.delay);
            this.animateCode(this.c8, this.time * 4, this.delay);
            ...
            this.animateCode(this.pseudo3, this.time * 4, this.delay);
